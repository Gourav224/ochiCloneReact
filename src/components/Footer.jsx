const Footer = () => {
    return (
        <div
            ...
            className="w-full h-screen bg-zinc-900 p-20 flex gap-5 font-['Founders Grotesk X-Condensed']"
        >
            <div className="w-1/2 h-full flex flex-col justify-between">
                <div className="heading">
                    <h1 className="text-[5vw] font-semibold uppercase leading-none -mb-2 tracking-tight">
                        Eye-
                    </h1>
                    <h1 className="text-[5vw] font-semibold uppercase leading-none -mb-2 tracking-tight">
                        Opening
            ...
            <div className="w-1/2 ">
                ...
                <div className="dets font-['Neue_Montreal'] font-light mt-10">
